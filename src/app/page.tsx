...
export default function Home() {
  return (
    <div>
      ...
      <section
        id="ABOUT"
        className="hero2 bg-slate-900 pt-14 text-white px-4 md:px-20 xs:py-16 py-12"
      >
      ...
      <section id="WORK" className="hero5 px-4 md:px-20 xs:py-16 py-12">
        <Heading
          heading="WORK"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-none md:grid-flow-row gap-4">
          <Projectcard
            ...
            alt={"resume"}
            address="https://vercel.com/api/toolbar/link/hackathon-4-tau.vercel.app?via=team-dashboard-project-entity&p=1&page=/"
          />
          <Projectcard
            src="/images/Game.png"
      ...
      <section
        id="TESTIMONIALS"
        className="hero6 bg-slate-900 px-4 md:px-20 xs:py-16 py-12"
      >
        <Heading
      ...
      <section
        id="CONTACT"
        className="hero7 bg-slate-950 px-4 md:px-20 xs:py-16 py-12"
      >
        <Heading
